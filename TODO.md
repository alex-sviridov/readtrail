...
- [x] GDPR (delete account, download data)
- [ ] Import of exported data (with solving conflicts options)
- [ ] Add books backlog
...
- [ ] Hide Unfinished button >> Unfinished
- [ ] Long Ago button has newline in mobile view, fix
- [x] Save library view type when moving back and forth

# Prettify
- [ ] unfinished checkbox to be prettier
- [ ] timeline switch

# Performance
- [ ] Modal effects are slow and lagging
